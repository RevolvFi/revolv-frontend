<template>
  <div class="pb-4">
    <div class="subsection">
      <h1>Revolv Privacy&nbsp;Policy</h1>
      <p><em>Last Updated: August 2022</em></p>
      <p>
        <em class="font-medium">
          This Privacy Policy explains how the Revolv Foundation, its
          subsidiary, Cent Finance Limited (“Revolv Foundation,” “Revolv,” “we,”
          “our,” or “us”) collects, uses, and discloses information about you.
          This Privacy Policy applies when you use our website, Revolv Protocol
    ...
    <div class="subsection">
      ...
      <ul>
        <li>
          Revolv does not typically request, collect or use personal
        ...
        <li>
          Revolv does not and has not stored personal information from users of
          the UI. However, Revolv uses third party services including, without
        ...
        <li>
          Revolv does not set any cookies. However, it’s possible we may use
    ...
    <div class="subsection">
      ...
      <p>
        Revolv is not directed to children under the age of 16. If a parent or
      ...
      <p>
        ...
        service providers. Your wallet and IP address is accessible to Revolv
    ...
    <div class="subsection">
      ...
      <ul>
        <li>Ensure proper functioning of Revolv and the UI;</li>
        <li>
        ...
        <li>
          ...
          rights and property of Revolv and others;
        </li>
    ...
    <div class="subsection">
      ...
      <p>
        ...
        other than as described herein, in the normal course of Revolv business.
        However, when Revolv has access to personal information, such as your
      ...
      <ul>
        ...
        <li>
          ...
          the rights, property, and safety of Revolv, the Revolv ecosystem, the
          public, or others.
        </li>
        <li>
        ...
        <li>
          Personal information may be shared between and among Revolv and our
    ...
    <div class="subsection">
      ...
      <p>
        Revolv Foundation is headquartered in the Cayman Islands with a
    ...
    <div class="subsection">
      ...
      <h3>Cookies</h3>
      <p>
        Revolv does not typically use any cookies. It reserves the ability to
    ...
    <div class="subsection">
      ...
      <p>
        Revolv does not “sell” personal information to advertise our products to
        you or otherwise.
      </p>
      ...
      <p>
        Revolv does not share such information with third parties for direct
        marketing purposes.
      </p>
    ...
    <div class="subsection">
      ...
      <p>
        Revolv does not typically process user personal data. If Revolv
      ...
      <p>
        ...
        certain processing. Revolv does not typically hold or store such
        personal data.
      </p>
    </div>
    <div>
